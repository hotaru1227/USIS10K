...
work_dir = './work_dirs/MONUSEGDataset/huge'
...
# dataset settings
dataset_type = 'ForegroundMONUSEGInsSegDataset'
data_root = 'data/monuseg_coco'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/monuseg_coco/annotations/train.json',
        data_prefix=dict(img='yolo/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/monuseg_coco/annotations/val.json',
        data_prefix=dict(img='yolo/val'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/monuseg_coco/annotations/test.json',
        data_prefix=dict(img='yolo/test'),
        test_mode=True,
        pipeline=test_pipeline,
        backend_args=backend_args)
)
