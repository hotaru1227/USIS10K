...
work_dir = './work_dirs/CPM17Dataset/huge'
...
# dataset settings
dataset_type = 'ForegroundCPMInsSegDataset'
data_root = 'data/cpm'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/cpm/annotations/train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/cpm/annotations/val.json',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file='/data/hotaru/projects/USIS10K/data/cpm/annotations/test.json',
